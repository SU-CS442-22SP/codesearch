...
#get raw python files downlaoda and read them.
...
#function for seperating docs with/without docstrings
def listlen(x):
...
if __name__ == '__main__':    
    ...
    #REMOVE DUPLICATES remove observations where the same function appears more than once
    before_dedup = len(df)
